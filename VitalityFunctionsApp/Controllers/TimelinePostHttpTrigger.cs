...
namespace VitalityFunctionsApp.Controllers
{
    ...
    public class TimelinePostHttpTrigger
    {
        ...
        [OpenApiResponseWithBody(statusCode: HttpStatusCode.OK, contentType: "application/json", bodyType: typeof(List<TimelinePost>), Summary = "Successful operation", Description = "Successful operation", Example = typeof(List<TimelinePostExample>))]
        [UnauthorizedRequest]
        [ForbiddenRequest]
        ...
        [OpenApiResponseWithBody(statusCode: HttpStatusCode.OK, contentType: "application/json", bodyType: typeof(TimelinePost), Summary = "Successful operation", Description = "Successful operation", Example = typeof(TimelinePostExample))]
        [UnauthorizedRequest]
        [ForbiddenRequest]
        [OpenApiResponseWithoutBody(statusCode: HttpStatusCode.BadRequest, Summary = "Bad request", Description = "Bad request")]
        [OpenApiResponseWithoutBody(statusCode: HttpStatusCode.NotFound, Summary = "No posts found", Description = "No posts found")]
